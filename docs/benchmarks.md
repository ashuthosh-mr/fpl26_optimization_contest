...
| Benchmark | Initial Fmax (MHz) | Best Fmax (MHz) | Improvement (MHz) | Improvement (%) | WNS Change (ns) | Runtime | Status | first_opt (MHz) / runtime(43dd108)  |
|---|---:|---:|---:|---:|---|---:|---|---:|
| `amd_mini-isp` | 307.13 | 375.38 | +68.25 | +22.2% | -1.686 → -1.094 | 619s | Completed | 375.38 / 66 |
| `boom_soc` | 48.24 | 50.77 | +2.53 | +5.2% | -19.162 → -18.126 | 3601s | Timed out | - |
| `corescore_500_mod` | 344.23 | 423.37 | +79.14 | +23.0% | -1.238 → -0.695 | 2131s | Completed | 346 / 238 |
| `finn_radioml` | 284.90 | 324.46 | +39.56 | +13.9% | -1.910 → -1.482 | 1998s | Completed | 284 / 224 |
| `ispd16_example2` | 107.64 | 107.64 | +0.00 | +0.0% | -7.752 → -7.752 | 3600s | Timed out | - |
| `logicnets_jscl` | 403.55 | 434.97 | +31.42 | +7.8% | -0.978 → -0.799 | 825s | Completed | 410 / 72 |
| `rosetta_3d-rendering` | 270.93 | 279.25 | +8.32 | +3.1% | -2.153 → -2.043 | 1823s | Completed | 276 / 138 |
| `rosetta_digit-recognition` | 366.97 | 390.78 | +23.81 | +6.5% | -1.025 → -0.859 | 1512s | Completed | 366 / 149 |
| `rosetta_optical-flow` | 324.89 | 330.14 | +5.26 | +1.6% | -1.078 → -1.029 | 558s | Completed | 325 / 109 |
| `rosetta_spam-filter` | 437.45 | 494.07 | +56.63 | +12.9% | -0.686 → -0.424 | 1000s | Completed | 437 / 90 |
| `vexriscv_re-place` | 310.17 | 415.28 | +105.11 | +33.9% | -1.654 → -0.838 | 385s | Completed | 411.18 / 60 |
| `vtr_mcml` | 62.25 | 73.05 | +10.80 | +17.4% | -14.527 → -12.152 | 1689s | Completed | 64.42 / 259 |
